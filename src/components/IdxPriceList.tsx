...
const MARKET_SYMBOLS: Record<string, Record<string, string>> = {
  IDX: {
    ...
    "CDIO": "PT Cipta Daya Indonesia Tbk.",
    ...
    "CTTH": "PT Citatah Tbk.",
    "BACH": "PT Batavia Alumina Chemical Tbk.",
    "EMMI": "PT Eka Mas Mandiri Indonesia Tbk.",
    "JECX": "PT Jakarta Electronic Commerce Tbk.",
    "PRDL": "PT Pratama Real Estate Development Tbk.",
    "RANS": "PT Rona Adi Nusantara Sejahtera Tbk.",
    "PJHB-W": "PT Panca Jaya Hanurata Warrant"
  },
  SGX: {
