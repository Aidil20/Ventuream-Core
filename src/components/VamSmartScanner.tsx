...
function VamSmartScanner() {
  ...
  return (
    <div className="secure-scanner-container border border-[#FFD700] rounded-3xl overflow-hidden bg-slate-950 shadow-2xl shadow-[#FFD700]/5">
      <div className="scanner-header bg-slate-900/80 p-3 text-[#FFD700] text-[10px] font-black uppercase tracking-[0.2em] border-b border-slate-800 flex items-center gap-2">
