...
const PRESET_TICKERS = [
  ...
  { symbol: 'ACES.JK', name: 'Aspirasi Hidup Indonesia' },
  { symbol: 'EMTK.JK', name: 'Elang Mahkota Teknologi' },
  { symbol: 'BSDE.JK', name: 'Bumi Serpong Damai' },
  { symbol: 'MNCN.JK', name: 'Media Nusantara Citra' },
  { symbol: 'GOTO-W.JK', name: 'GoTo Tokopedia Warrant' }
];

const ALL_SUGGESTIONS = [
  // IDX Stocks
  { symbol: 'BUMI.JK', name: 'PT Bumi Resources Tbk.', priceKey: 'BUMI', market: 'IDX' },
  { symbol: 'BBCA.JK', name: 'PT Bank Central Asia Tbk.', priceKey: 'BBCA', market: 'IDX' },
  { symbol: 'BBRI.JK', name: 'PT Bank Rakyat Indonesia (Persero) Tbk.', priceKey: 'BBRI', market: 'IDX' },
  { symbol: 'BMRI.JK', name: 'PT Bank Mandiri (Persero) Tbk.', priceKey: 'BMRI', market: 'IDX' },
  { symbol: 'TLKM.JK', name: 'PT Telkom Indonesia (Persero) Tbk.', priceKey: 'TLKM', market: 'IDX' },
  { symbol: 'ASII.JK', name: 'PT Astra International Tbk.', priceKey: 'ASII', market: 'IDX' },
  { symbol: 'BBNI.JK', name: 'PT Bank Negara Indonesia (Persero) Tbk.', priceKey: 'BBNI', market: 'IDX' },
  { symbol: 'ADRO.JK', name: 'PT Adaro Energy Indonesia Tbk.', priceKey: 'ADRO', market: 'IDX' },
  { symbol: 'UNVR.JK', name: 'PT Unilever Indonesia Tbk.', priceKey: 'UNVR', market: 'IDX' },
  { symbol: 'GOTO.JK', name: 'PT GoTo Gojek Tokopedia Tbk.', priceKey: 'GOTO', market: 'IDX' },
  { symbol: 'ANTM.JK', name: 'PT Aneka Tambang Tbk.', priceKey: 'ANTM', market: 'IDX' },
  { symbol: 'MDKA.JK', name: 'PT Merdeka Copper Gold Tbk.', priceKey: 'MDKA', market: 'IDX' },
  { symbol: 'PTBA.JK', name: 'PT Bukit Asam Tbk.', priceKey: 'PTBA', market: 'IDX' },
  { symbol: 'ITMG.JK', name: 'PT Indo Tambangraya Megah Tbk.', priceKey: 'ITMG', market: 'IDX' },
  { symbol: 'HRUM.JK', name: 'PT Harum Energy Tbk.', priceKey: 'HRUM', market: 'IDX' },
  { symbol: 'SMGR.JK', name: 'PT Semen Indonesia (Persero) Tbk.', priceKey: 'SMGR', market: 'IDX' },
  { symbol: 'AMRT.JK', name: 'PT Sumber Alfaria Trijaya Tbk.', priceKey: 'AMRT', market: 'IDX' },
  { symbol: 'ICBP.JK', name: 'PT Indofood CBP Sukses Makmur Tbk.', priceKey: 'ICBP', market: 'IDX' },
  { symbol: 'BRPT.JK', name: 'PT Barito Pacific Tbk.', priceKey: 'BRPT', market: 'IDX' },
  { symbol: 'BREN.JK', name: 'PT Barito Renewables Energy Tbk.', priceKey: 'BREN', market: 'IDX' },
  { symbol: 'AMMN.JK', name: 'PT Amman Mineral Internasional Tbk.', priceKey: 'AMMN', market: 'IDX' },
  { symbol: 'TPIA.JK', name: 'PT Chandra Asri Pacific Tbk.', priceKey: 'TPIA', market: 'IDX' },
  { symbol: 'CPIN.JK', name: 'PT Charoen Pokphand Indonesia Tbk.', priceKey: 'CPIN', market: 'IDX' },
  { symbol: 'BRMS.JK', name: 'PT Bumi Resources Minerals Tbk.', priceKey: 'BRMS', market: 'IDX' },
  { symbol: 'COAL.JK', name: 'PT Black Diamond Resources Tbk.', priceKey: 'COAL', market: 'IDX' },
  { symbol: 'DEFI.JK', name: 'PT Danasupra Erapacific Tbk.', priceKey: 'DEFI', market: 'IDX' },
  { symbol: 'BUKA.JK', name: 'PT Bukalapak.com Tbk.', priceKey: 'BUKA', market: 'IDX' },
  { symbol: 'MEDC.JK', name: 'PT Medco Energi Internasional Tbk.', priceKey: 'MEDC', market: 'IDX' },
  { symbol: 'DEWA.JK', name: 'PT Darma Henwa Tbk.', priceKey: 'DEWA', market: 'IDX' },
  ...
  { symbol: 'SMGA.JK', name: 'PT Sumber Mineral Global Abadi Tbk.', priceKey: 'SMGA', market: 'IDX' },
  { symbol: 'GRPH.JK', name: 'PT Griptha Putra Persada Tbk.', priceKey: 'GRPH', market: 'IDX' },
  { symbol: 'HYGN.JK', name: 'PT Ecocare Indo Pasifik Tbk.', priceKey: 'HYGN', market: 'IDX' },
  ...
  { symbol: 'ACES.JK', name: 'PT Aspirasi Hidup Indonesia Tbk.', priceKey: 'ACES', market: 'IDX' },
  { symbol: 'EMTK.JK', name: 'PT Elang Mahkota Teknologi Tbk.', priceKey: 'EMTK', market: 'IDX' },
  { symbol: 'BSDE.JK', name: 'PT Bumi Serpong Damai Tbk.', priceKey: 'BSDE', market: 'IDX' },
  { symbol: 'MNCN.JK', name: 'PT Media Nusantara Citra Tbk.', priceKey: 'MNCN', market: 'IDX' },
  { symbol: 'GOTO-W.JK', name: 'PT GoTo Gojek Tokopedia Warrant', priceKey: 'GOTO-W', market: 'IDX' },
