...
const ALL_SUGGESTIONS = [
  ...
  { symbol: 'BACH.JK', name: 'PT Batavia Alumina Chemical Tbk.', priceKey: 'BACH', market: 'IDX' },
  { symbol: 'EMMI.JK', name: 'PT Eka Mas Mandiri Indonesia Tbk.', priceKey: 'EMMI', market: 'IDX' },
  { symbol: 'JECX.JK', name: 'PT Jakarta Electronic Commerce Tbk.', priceKey: 'JECX', market: 'IDX' },
  { symbol: 'PRDL.JK', name: 'PT Pratama Real Estate Development Tbk.', priceKey: 'PRDL', market: 'IDX' },
